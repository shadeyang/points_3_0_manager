...
public class DruidConfig {
    ...
    @ConditionalOnProperty(prefix = "spring.datasource.druid.customer", name = "enabled", havingValue = "true")
    public DataSource customerDataSource(DruidProperties druidProperties) {
        DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
        return druidProperties.dataSource(dataSource);
    }
    ...
    @ConfigurationProperties("spring.datasource.druid.merchant")
    @ConditionalOnProperty(prefix = "spring.datasource.druid.merchant", name = "enabled", havingValue = "true")
    public DataSource merchantDataSource(DruidProperties druidProperties) {
        DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
        return druidProperties.dataSource(dataSource);
    }
    ...
    public DynamicDataSource dataSource(DataSource masterDataSource) {
        ...
        setDataSource(targetDataSources, DataSourceType.CUSTOMER.name(), "customerDataSource");
        ...
        setDataSource(targetDataSources, DataSourceType.MERCHANT.name(), "merchantDataSource");
    ...
    public void setDataSource(Map<Object, Object> targetDataSources, String sourceName, String beanName) {
        try {
            ...
            log.warn("初始化链接池失败：" + e.getMessage());
        } catch (Exception e) {
            log.warn("初始化链接池失败：" + e);
        }
    }
